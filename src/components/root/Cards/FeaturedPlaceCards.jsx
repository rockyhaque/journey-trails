...
export default function FeaturedPlaceCards() {
  const travelInfo = {
    id: "01",
  ...
  return (
    <div className="max-w-sm overflow-hidden group border p-2 rounded-lg bg-gradient-to-r from-neutral-50 to-sky-50">
