...
const Signup = () => {
  ...
  return (
    <div className="relative flex h-screen my-96">
      {/* Left Background */}
      <div className="absolute left-0 top-0 h-full w-1/2 md:bg-login-pattern bg-cover bg-center -z-10"></div>

      {/* Right Background */}
      <div className="absolute right-0 top-0 h-full w-1/2 bg-white -z-10"></div>
