...
export default function NotFound() {
  return (
    <div>
      <div className="h-screen w-screen flex items-center my-20 md:my-0 px-14 md:px-3">
        <div className="container flex flex-col md:flex-row items-center justify-center pt-10 md:pt-0 text-gray-700">
